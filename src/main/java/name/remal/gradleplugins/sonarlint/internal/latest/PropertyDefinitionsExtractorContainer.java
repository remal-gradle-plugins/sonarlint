...
class PropertyDefinitionsExtractorContainer extends AbstractExtractorContainer {
    ...
    private final SonarLintExecutionParams params;

    public PropertyDefinitionsExtractorContainer(
    ...
    protected void doBeforeStart() {
        ...
        add(
            ...
            PropertyDefinition.builder("sonar.nodejs.version")
                ...
                .defaultValue(defaultValue(params.getDefaultNodeJsVersion().getOrNull()))
                .build()
        );
    }
