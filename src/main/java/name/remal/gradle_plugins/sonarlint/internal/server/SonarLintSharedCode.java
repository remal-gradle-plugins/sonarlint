...
import static name.remal.gradle_plugins.sonarlint.internal.server.LogOutputViaSlf4j.LOG_OUTPUT_VIA_SLF4J;
...
public class SonarLintSharedCode implements AutoCloseable {
    ...
    private Path createTempDir() {
        var dir = createTempDirectory(getClass().getSimpleName() + "-");
        registerCloseable(() -> tryToDeleteRecursivelyIgnoringFailure(dir));
        return dir;
    }
