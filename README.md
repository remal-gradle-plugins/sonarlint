...
**Tested on Gradle versions from <!--property:gradle-api.min-version-->7.5<!--/property--> to <!--property:gradle-api.max-version-->9.6.0<!--/property-->.**
...
```groovy
plugins {
    id 'name.remal.sonarlint' version '7.1.1'
}
```
<!--/plugin-usage-->
