...
**Tested on Gradle versions from <!--property:gradle-api.min-version-->7.5<!--/property--> to <!--property:gradle-api.max-version-->9.1.0-rc-3<!--/property-->.**
...
```groovy
plugins {
    id 'name.remal.sonarlint' version '7.0.0-rc-1'
}
```
<!--/plugin-usage-->
