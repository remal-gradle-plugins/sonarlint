...
**Tested on Gradle versions from <!--property:gradle-api.min-version-->7.5<!--/property--> to <!--property:gradle-api.max-version-->9.7.0-rc-1<!--/property-->.**
...
```groovy
plugins {
    id 'name.remal.sonarlint' version '7.1.4'
}
```
<!--/plugin-usage-->
